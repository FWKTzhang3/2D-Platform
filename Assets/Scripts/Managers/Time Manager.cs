...
public class TimeManager : MonoBehaviour
{
     ...
     /// <param name="recoverAcceleration"> 缓震时间 </param>
     ...
     /// <param name="timeScaleAcceleration"> 缓震速度 </param>
     IEnumerator HitStopCoroutine(float stutterTime, float timeScaleAcceleration)
     {
